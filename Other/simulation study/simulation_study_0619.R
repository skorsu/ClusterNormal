...
dat_used <- as.numeric(scale(list_data[[1]]$dat, center = scale_dat, scale = scale_dat))
...
SFDMM_mod <- SFDMM_model(iter = 10000, K_max = 10, init_assign = rep(0, 500), 
                         y = dat_used, a0 = 0.1, b0 = 0.1, mu0 = 0, s20 = 100, 
                         xi0 = 1, a_theta = 1, b_theta = 1, launch_iter = 10, 
                         print_iter = 2500)
SFDMM_assign <- as.numeric(salso(SFDMM_mod$iter_assign[-(1:5000), ], maxNClusters = 10))
...
SFCMM_mod <- SFCMM_model(iter = 10000, K_max = 10, init_assign = rep(0, 500), 
                         y = dat_used, a0 = 0.1, b0 = 0.1, mu0 = 0, s20 = 100, 
                         xi0 = 1, launch_iter = 10, print_iter = 2500)
SFCMM_assign <- as.numeric(salso(SFCMM_mod$iter_assign[-(1:5000), ], maxNClusters = 10))
...
apply(assign_result, 2, table, list_data[[1]]$actual_clus)
